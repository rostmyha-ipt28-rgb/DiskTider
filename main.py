...
def main():
    ...
    # Информируем о режиме безопасности
    if TRASH_AVAILABLE:
        print("⚠️  Файлы будут перемещены в Корзину! Это безопасный режим.")
    else:
        print("❌ send2trash не установлен. Удаление будет НЕОБРАТИМЫМ! Будьте осторожны.")
